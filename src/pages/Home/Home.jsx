    ...
    <>
      <div className='header'>
        <div className='inner-header flex'>
          <h2>👋, I'm <a href='https://github.com/edgeorgie' target='_blank' rel='noreferrer'><u>Edwin</u></a>.</h2>
          <h1>Welcome to my technical test</h1>
          <div className='home-container'>
            <div className='home-container--content'>
              <div className='home-container--content-subtitle'>
                <h3>To made it possible I chose the <a href='https://valorant-api.com/'><i>Valorant API.</i></a></h3>
              ...
              <div className='home-container--content-list'>
                <div>
                  ...
                  <li>React, React Hooks (useState, useRef, useEffect...)</li>
                </div>
              </div>
            </div>
          </div>
